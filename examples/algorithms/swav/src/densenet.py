...
class _DenseLayer(nn.Module):
    ...
    # @Tony: maybe we can remove all of the torchscript stuff? Not sure...
...
class DenseNet(nn.Module):
    def __init__(
        ...
        # First convolution
        # TODO: check if extra padding is needed (as in ResNets)
        # see https://github.com/facebookresearch/swav/issues/81
